...
**IMPORTANT NOTE:** Unfortunately, because of the way generation works. It is important to keep grid size small. Otherwise there may be cases of separated clusters of the hallways that are not connected at all to each other.
